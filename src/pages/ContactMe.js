...
const ContactMe = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.subject || !formData.message) {
      ...
      const url = `mailto:chindatrate@me.com?subject=${formData.subject}&body=${formData.message}`
      window.open(url);
    }
  };
  return (
    <div className="row">
      ...
      <div className="col-4 p-0">
        <h3>Links:</h3>
        <a href="https://github.com/chindatrate" target="_blank">
          <i className="fab fa-github fa-2x m-2"></i>GitHub
        </a>
        <br />
        <a href="https://www.linkedin.com/in/chinda-trate-242b9661/" target="_blank">
          <i className="fab fa-linkedin fa-2x m-2"></i>LinkedIn
        </a>
        <br />
        <a href="mailto:chindatrate@me.com" target="_blank">
